  ...
  return (
    ...
    >
      ...
      <div className="d-flex flex-row">
        <div>
          <img src={require("../../img/chef.png").default} alt="Chef" style={{ float: 'left', marginRight: '10px' }} />
        </div>
        <div className="fondo-transparente p-3 mb-3 mt-4">
          <div className="p-4" style={{color:"black",}}><p>
